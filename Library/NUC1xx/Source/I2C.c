...
#define I2C_PORT_NO   I2C_PORT1
#define I2C_CTRL_SIG  (__IO uint32_t *)&I2C1->I2CON
#define I2C_DATAPORT  I2C1->I2CDAT
#define I2C_FLAG_SI   I2C1->I2CON.SI
#define I2C_FLAG_STO  I2C1->I2CON.STO
#endif
